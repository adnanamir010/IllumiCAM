...
def main():
    ...
    parser.add_argument("--lsmi_root", type=str, default="Data/LSMI/nikon")
    parser.add_argument("--output_dir", type=str, default="Data/LSMI_Masks")
    parser.add_argument("--centroids_file", type=str, default="cluster_centers.npy")
